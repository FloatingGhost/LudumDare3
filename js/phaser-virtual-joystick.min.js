...
Phaser.VirtualJoystick = function (a, b) {
    ...
    checkDown: function (a) {
        ...
        var b = this.baseSprite.width / 2 + a, c = this.baseSprite.height / 2 + a;
        ...
        for (var a = this.pad.game.input.moveCallbacks, b = 0; b < a.length; b++)if (a.callback === this.moveStick && a.context === this) {
            a.splice(b, 1);
            break
        }
        ...
        if (a && (d.context.lineWidth = 2, d.geom(this.baseHitArea, "rgba(255, 0, 0, 1)", !1), d.geom(this.stickHitArea, "rgba(0, 255, 0, 1)", !1), d.geom(this.line, "rgba(255, 255, 0, 1)"), d.context.lineWidth = 1), b) {
            var e = d.renderShadow, f = c, g = this.baseSprite.y - 114;
    ...
    addKey: function (a) {
        ...
        "undefined" == typeof a && (a = 0);
        var b = this.sprite.width / 2 + a, c = this.sprite.height / 2 + a;
        this.posX = b, this.posY = this.pad.game.height - c
    }, alignBottomRight: function (a) {
        "undefined" == typeof a && (a = 0);
        var b = this.sprite.width / 2 + a, c = this.sprite.height / 2 + a;
    ...
    checkDown: function (a) {
        ...
        var d = this.pad.game.debug;
        if (a && (d.context.lineWidth = 2, d.geom(this.baseHitArea, "rgba(255, 0, 0, 1)", !1), d.geom(this.stickHitArea, "rgba(0, 255, 0, 1)", !1), d.geom(this.line, "rgba(255, 255, 0, 1)"), d.context.lineWidth = 1), b) {
            var e = d.renderShadow, f = c, g = this.sprite.y - 48;
